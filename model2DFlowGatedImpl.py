...
def get_dataloaders(num_of_frames):
    ...
    dir = ""
    src_train_fight_path = dir + 'RWF-2000-CroppedOpticalFlow/train/Fight/'
    src_train_non_fight_path = dir + 'RWF-2000-CroppedOpticalFlow/train/NonFight/'

    # validation data path
    src_val_fight_path = dir + 'RWF-2000-CroppedOpticalFlow/val/Fight/'
    src_val_non_fight_path = dir + 'RWF-2000-CroppedOpticalFlow/val/NonFight/'
...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25, is_inception=False):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels, optical_flow in dataloaders[phase]:
                ...
                optical_flow = optical_flow.type(torch.FloatTensor)
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    if is_inception and phase == 'train':
                        ...
                        optical_flow = optical_flow.repeat(1, 2048, 1, 1)
    ...
    torch.save(model_wts, "/home/csci5980/saluj012/FirstModel_" + str(num_epochs) + ".pt") 
    return model, val_loss_history, trn_loss_history


def plotLoss(val_hist_loss, trn_hist_loss):
    plt.title("Loss vs. Number of Training Epochs")
    plt.xlabel("Training Epochs")
    plt.ylabel("Loss")
    plt.plot(range(1, num_epochs + 1), trn_hist_loss, label="Training Loss")
    plt.plot(range(1, num_epochs + 1), val_hist_loss, label="Validation Loss")
    # plt.ylim((0,1.))
...
if __name__ == '__main__':
    ...
    # Train and evaluate
    model_ft, v_loss_hist, tr_loss_hist = train_model(model_ft, dataloaders_dict, criterion, optimizer_ft,
                                                      num_epochs=num_epochs,
                                                      is_inception=(model_name == "inception"))
    # plotLoss(v_loss_hist, tr_loss_hist)
